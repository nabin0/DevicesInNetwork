...
import static com.example.demofornetworkdevices.Config.EMPTY_DOMAIN;
import static com.example.demofornetworkdevices.Config.TCP_REG_TYPE_SUFFIX;
import static com.example.demofornetworkdevices.Config.UDP_REG_TYPE_SUFFIX;
...
public class RegTypeBrowserViewModel extends AndroidViewModel {
    ...
    public void startDiscovery(Consumer<Collection<BonjourDomain>> servicesAction, Consumer<Throwable> errorAction) {
        ...
        Log.d("TAG", "startDiscovery:" + mDisposable.toString());
    }
